...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета) Экспорт 
	...
	Возврат "Отчет по продажам (с диаграммой)" + БухгалтерскиеОтчетыКлиентСервер.ПолучитьПредставлениеПериода(ПараметрыОтчета.НачалоПериода, ПараметрыОтчета.КонецПериода);
...
Функция ВариантыНастроек() Экспорт
	...
	Массив = Новый Массив;
	Массив.Добавить(Новый Структура("Имя, Представление","ОтчетПоПродажамСДиаграммой", "Отчет по продажам (с диаграммой)"));	
	Возврат Массив;
