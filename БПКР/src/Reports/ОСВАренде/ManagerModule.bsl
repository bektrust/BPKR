...
Функция ВариантыНастроек() Экспорт
	Массив = Новый Массив;
	Массив.Добавить(Новый Структура("Имя, Представление","ОСВАренде", НСтр("ru = 'ОС в аренде'")));
	Возврат Массив;
КонецФункции
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ОСВАренде");
	НастройкиВарианта.Описание = НСтр("ru = 'ОС в аренде'");
...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета) Экспорт 
	...
	Возврат "ОС в аренде на " + Формат(ПараметрыОтчета.Период, "ДЛФ=D; ДП=...");;
