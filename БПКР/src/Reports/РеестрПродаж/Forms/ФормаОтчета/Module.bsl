...
Процедура ПриЗагрузкеВариантаНаСервере(Настройки)
	...
	ЗаполнитьНастройкамиПоУмолчанию(Новый Структура("Показатели", Истина));
...
Функция ПодготовитьПараметрыОтчетаНаСервере()
	...
	ПараметрыОтчета.ПоказательНСПТорговля				= Отчет.ПоказательНСПТорговля;
	ПараметрыОтчета.ПоказательНСППрочее					= Отчет.ПоказательНСППрочее;
	ПараметрыОтчета.ПоказательНСПТорговляОсвобожденные	= Отчет.ПоказательНСПТорговляОсвобожденные;
	ПараметрыОтчета.ПоказательНСППрочееОсвобожденные	= Отчет.ПоказательНСППрочееОсвобожденные;
	ПараметрыОтчета.ПоказательНСПСотоваяСвязь			= Отчет.ПоказательНСПСотоваяСвязь;
	ПараметрыОтчета.ПоказательНСПЗастройщикиЖилья		= Отчет.ПоказательНСПЗастройщикиЖилья;
	ПараметрыОтчета.ПоказательНСПУслугиБанка			= Отчет.ПоказательНСПУслугиБанка;
...
Процедура ЗаполнитьНастройкамиПоУмолчанию(ЗаполняемыеНастройки)
	...
	Если ЗаполняемыеНастройки.Свойство("Показатели") И ЗаполняемыеНастройки.Показатели Тогда
		Отчет.ПоказательНСПТорговля	= Истина;
		Отчет.ПоказательНСППрочее	= Истина;
	КонецЕсли;
