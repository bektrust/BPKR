...
Процедура ПредварительныйПросмотрВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ОборудованиеПринтерыЭтикетокКлиент.НачатьРедактированиеМакета(Оповещение, XMLОписаниеМакета, АдресХранилищаСКД);
КонецПроцедуры
...
Процедура ЗаполнитьПоДаннымМакета()
	...
	ИначеЕсли ОборудованиеПринтерыЭтикетокВызовСервера.ПолучитьОписаниеМакета(ОписаниеМакетаСтрокой, СообщениеОбОшибке, СодержимоеXMLФайла) Тогда
