...
Функция ТипЦенРозничная() Экспорт
	...
	Запрос.Текст = 
		...
		|ГДЕ
		|	ТипыЦенНоменклатуры.Наименование = ""Розничная""
	...
	Если ВыборкаДетальныеЗаписи.Следующий() Тогда 
		ТипЦен = ВыборкаДетальныеЗаписи.Ссылка
	КонецЕсли;
	
	Возврат ТипЦен;
	
КонецФункции // ТипЦенРозничная()
...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Для Каждого СтрокаТаблицыЗначений Из КлассификаторТаблица Цикл
		...
		ЗначенияЗаполнения.Вставить("ВалютаЦены", Справочники.Валюты.НайтиПоКоду(СтрокаТаблицыЗначений.Валюта));
