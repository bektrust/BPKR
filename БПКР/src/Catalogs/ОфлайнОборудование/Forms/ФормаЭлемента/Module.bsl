...
#КонецЕсли
	...
	Элементы.ОбработчикОфлайнОборудования.СписокВыбора.Добавить(Перечисления.ОбработчикиОфлайнОборудования.Обработчик1СККМED, НСтр("ru = '1С:Офлайн оборудование'"));
	Элементы.ОбработчикОфлайнОборудования.СписокВыбора.Добавить(Перечисления.ОбработчикиОфлайнОборудования.Обработчик1СККМОфлайн, НСтр("ru = '1С:ККМ ED'"));
