...
Процедура РедактироватьШаблон(Команда)
	...
	ОборудованиеПринтерыЭтикетокКлиент.НачатьРедактированиеМакета(Оповещение, ПараметрыШаблонаЭтикеток.XMLОписаниеМакета, ПараметрыШаблонаЭтикеток.АдресХранилищаСКД);
КонецПроцедуры
