...
Процедура ЗагрузитьУслугиИзФайла(Команда)
    ...
    ПараметрыЗагрузки.ПолноеИмяТабличнойЧасти = "АктОбОказанииПроизводственныхУслуг.Услуги";
    ПараметрыЗагрузки.Заголовок = НСтр("ru = 'Загрузка списка услуг из файла'");
...
Функция ЗаполнитьПоДаннымШтрихкодов(ДанныеШтрихкодов, ИмяТабличнойЧасти) 
	...
	Для каждого ТекШтрихкод Из МассивШтрихкодов Цикл
		...
		ИначеЕсли НЕ СтруктураДанные.ТипНоменклатурыУслуга Тогда
