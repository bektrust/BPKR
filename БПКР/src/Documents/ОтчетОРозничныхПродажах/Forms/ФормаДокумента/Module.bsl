...
Процедура ОбновитьПодвалФормы()
	...
	ИтогСуммаБезналичные = Объект.Оплата.Итог("СуммаОплаты") - Объект.ВозвратОплаты.Итог("СуммаОплаты");
	ИтогСуммаНаличные = Объект.Товары.Итог("Всего") + Объект.Услуги.Итог("Всего") - ИтогСуммаБезналичные - Объект.Возвраты.Итог("Всего") - Объект.ВозвратУслуг.Итог("Всего") + Объект.ПодарочныеСертификаты.Итог("Сумма");
	
	ИтогСуммаБезналичныеВозврат = Объект.ВозвратОплаты.Итог("СуммаОплаты");
	ИтогСуммаНаличныеВозврат = Объект.Возвраты.Итог("Всего") + Объект.ВозвратУслуг.Итог("Всего") - ИтогСуммаБезналичныеВозврат;
