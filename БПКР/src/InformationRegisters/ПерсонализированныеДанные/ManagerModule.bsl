...
Процедура ОбновитьДанные(Организация, Дата = Неопределено, ИнтервалОбновления = 0, РазделыПерсонализированныхДанных = Неопределено) Экспорт
	...
	Для каждого Раздел из РазделыПерсонализированныхДанных Цикл
		...
		Если Раздел = Перечисления.РазделыПерсонализированныхДанных.КоличествоКонтрагентов Тогда
		...
		ИначеЕсли Раздел = Перечисления.РазделыПерсонализированныхДанных.КоличествоСчетовНаОплату Тогда
			ТаблицаДанных = ПерсонализированныеПредложенияСервисов.ПолучитьКоличествоСчетовНаОплатуДляПерсонализированныхДанных(ДатаПолученияДанных);
