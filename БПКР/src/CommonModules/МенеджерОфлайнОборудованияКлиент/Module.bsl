...
Функция ЗаполнениеПараметровУстройства(ОбработчикУстройстваОфлайн, Параметры);
	...
	Если ОбработчикУстройстваОфлайн <> Неопределено Тогда
		Если ОбработчикУстройстваОфлайн = ПредопределенноеЗначение("Перечисление.ОбработчикиОфлайнОборудования.Обработчик1СККМОфлайн") Тогда
...
Функция ОбработчикДрайвераОфлайнОборудования(ОбработчикДрайвера)
	...
	Если ОбработчикДрайвера <> Неопределено Тогда
		Если ОбработчикДрайвера = ПредопределенноеЗначение("Перечисление.ОбработчикиОфлайнОборудования.Обработчик1СККМОфлайн") Тогда
