...
Функция НастройкиККМ() Экспорт
	...
	НастройкиККМ.Вставить("СистемаНалогообложения", "");
	НастройкиККМ.Вставить("ПлательщикНДС", "");
...
Функция ПрайсЛистККМ() Экспорт
	...
	ПрайсЛист.Вставить("ВидыТоваров",		Новый Массив);
	Возврат ПрайсЛист;
...
// * НомерСвязанногоДокументаККМ - Строка - номер связанного документа (возврат) (БРО_КР).
...
Функция ЧекККМ() Экспорт
	...
	Чек.Вставить("НомерСвязанногоДокументаККМ");
...
Функция ТоварЧекаККМ() Экспорт
	...
	СтруктураЗаписи.Вставить("СтавкаНСП");
