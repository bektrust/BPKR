...
Процедура НастройкиПользователейИПравПриСозданииНаСервере(Форма) Экспорт
	// БПКР
	НастройкиПрограммыПереопределяемыйБП.НастройкиПользователейИПравПриСозданииНаСервере(Форма);
	// Конец БПКР	
КонецПроцедуры
...
Процедура ИнтернетПоддержкаИСервисыПриСозданииНаСервере(Форма) Экспорт
	// БПКР
	НастройкиПрограммыПереопределяемыйБП.ИнтернетПоддержкаИСервисыПриСозданииНаСервере(Форма);
	// Конец БПКР	
КонецПроцедуры
...
Процедура ОрганайзерПриСозданииНаСервере(Форма) Экспорт
	// БПКР
	НастройкиПрограммыПереопределяемыйБП.ОрганайзерПриСозданииНаСервере(Форма);
	// Конец БПКР	
КонецПроцедуры
...
Процедура СинхронизацияДанныхПриСозданииНаСервере(Форма) Экспорт
	// БПКР
	НастройкиПрограммыПереопределяемыйБП.СинхронизацияДанныхПриСозданииНаСервере(Форма);
	// Конец БПКР	
КонецПроцедуры
