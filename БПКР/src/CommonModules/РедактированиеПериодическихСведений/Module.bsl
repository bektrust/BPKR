...
Процедура ЗаписатьНаборЗаписейПоСтруктуре(Форма, ИмяРегистра, СтруктураВедущихОбъектов, ИсключаемыеИменаКолонок = "", ДополнительныеСвойства = Неопределено) Экспорт
	...
	ТаблицаЗаписейФормы.Колонки.Удалить("ИсходныйНомерСтроки");
	Для Каждого ВедущийОбъект Из СтруктураВедущихОбъектов Цикл
		ТаблицаЗаписейФормы.ЗаполнитьЗначения(ВедущийОбъект.Значение, ВедущийОбъект.Ключ);
	КонецЦикла;
	...
	ТаблицаЗаписейБазыДанных = РегистрыСведений[ИмяРегистра].СоздатьНаборЗаписей();
	Для Каждого ВедущийОбъект Из СтруктураВедущихОбъектов Цикл
		ТаблицаЗаписейБазыДанных.Отбор[ВедущийОбъект.Ключ].Установить(ВедущийОбъект.Значение);
	КонецЦикла;
	ТаблицаЗаписейБазыДанных.Прочитать();
